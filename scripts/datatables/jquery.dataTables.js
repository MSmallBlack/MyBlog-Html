...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Showing _START_ to _END_ of _TOTAL_ item
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "Got a total of _TOTAL_ item to show (_START_ to _END_)"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfo": "Showing _START_ to _END_ of _TOTAL_ item",
			 ...
			 *  @type string
			 *  @default Showing 0 to 0 of 0 item
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoEmpty": "No item to show"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfoEmpty": "Showing 0 to 0 of 0 item",
			 ...
			 *  @type string
			 *  @default (filtered from _MAX_ total item)
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtered from _MAX_ total 111)",
